...
export const Contact =() => {
    ...
    const handleSubmit = async(e)=> {
        ...
        if(result.code === 200){
            ...
            setStatus({succes: false, message:'Somethign went wrong, please try again'})
        }
    }
    return (
        <section className="contact" id="connect">
            <Container>
                <Row className="align-items-center">
                    <Col md={6}>
                        <img src={Coding} alt="placeholderimage"/>
                    </Col>
                    <Col md={6}>
                        <h2>Get in touch</h2>
                        <form>
                            <Row>
                                ...
                                <Col>
                                <textarea row="6" value={formDetails.message} placeholder="Type your message here"onChange={(e)=> onFormUpdate('message', e.target.value)}/>
